...
public class BestLeaf extends NotSerializableException {
    Node leaf;
    double nL_IG;
    ArrayList<int[]> samplesRight;
    ArrayList<int[]> samplesLeft;
    int[] labelsRight = new int[10];
    int[] labelsLeft = new int[10];
    int depth;
    int pixel;

    public BestLeaf(Node leaf, double nL_IG, ArrayList<int[]> samplesRight,ArrayList<int[]> samplesLeft, int[] labelsRight, int[] labelsLeft, int depth, int pixel ){
        this.leaf = leaf;
        this.nL_IG = nL_IG;
    ...
    public ArrayList<int[]> getSamplesRight() {
        return samplesRight;
    }
    public ArrayList<int[]> getSamplesLeft() {
        return samplesLeft;
    }
